...
public class ItemTags extends ItemTagsProvider {
	...
	private void registerModTags() {
		getBuilder(ModTags.KNIVES).add(ModItems.FLINT_KNIFE, ModItems.IRON_KNIFE, ModItems.DIAMOND_KNIFE, ModItems.GOLDEN_KNIFE);
	...
	private void registerForgeTags() {
		...
		getBuilder(ForgeTags.COOKED_BEEF).add(Items.COOKED_BEEF, ModItems.BEEF_PATTY);
		getBuilder(ForgeTags.COOKED_CHICKEN).add(Items.COOKED_CHICKEN, ModItems.COOKED_CHICKEN_CUTS);
		getBuilder(ForgeTags.COOKED_EGGS).add(ModItems.FRIED_EGG)
		...
		getBuilder(ForgeTags.COOKED_FISHES_COD).add(Items.COOKED_COD, ModItems.COOKED_COD_SLICE);
		getBuilder(ForgeTags.COOKED_FISHES_SALMON).add(Items.COOKED_SALMON, ModItems.COOKED_SALMON_SLICE);

		getBuilder(ForgeTags.CROPS).add(ForgeTags.CROPS_CABBAGE, ForgeTags.CROPS_ONION, ForgeTags.CROPS_RICE, ForgeTags.CROPS_TOMATO);
		getBuilder(ForgeTags.CROPS_CABBAGE).add(ModItems.CABBAGE, ModItems.CABBAGE_LEAF);
		getBuilder(ForgeTags.CROPS_ONION).add(ModItems.ONION);
		getBuilder(ForgeTags.CROPS_RICE).add(ModItems.RICE)
				.addOptional(net.minecraft.tags.ItemTags.getCollection(), new ResourceLocation("swampexpansion", "rice"));
		getBuilder(ForgeTags.CROPS_TOMATO).add(ModItems.TOMATO);
		...
		getBuilder(ForgeTags.GRAIN_RICE).add(ModItems.RICE);
		...
		getBuilder(ForgeTags.MILK_BOTTLE).add(ModItems.MILK_BOTTLE);

		getBuilder(ForgeTags.PASTA).add(ForgeTags.PASTA_RAW_PASTA);
		getBuilder(ForgeTags.PASTA_RAW_PASTA).add(ModItems.RAW_PASTA);

		getBuilder(ForgeTags.RAW_BEEF).add(Items.BEEF, ModItems.MINCED_BEEF);
		getBuilder(ForgeTags.RAW_CHICKEN).add(Items.CHICKEN, ModItems.CHICKEN_CUTS);

		getBuilder(ForgeTags.RAW_FISHES).add(ForgeTags.RAW_FISHES_COD, ForgeTags.RAW_FISHES_SALMON, ForgeTags.RAW_FISHES_TROPICAL);
		getBuilder(ForgeTags.RAW_FISHES_COD).add(Items.COD, ModItems.COD_SLICE);
		getBuilder(ForgeTags.RAW_FISHES_SALMON).add(Items.SALMON, ModItems.SALMON_SLICE);
		...
		getBuilder(ForgeTags.SALAD_INGREDIENTS_CABBAGE).add(ModItems.CABBAGE, ModItems.CABBAGE_LEAF);

		getBuilder(ForgeTags.SEEDS).add(ForgeTags.SEEDS_CABBAGE, ForgeTags.SEEDS_RICE, ForgeTags.SEEDS_TOMATO);
		getBuilder(ForgeTags.SEEDS_CABBAGE).add(ModItems.CABBAGE_SEEDS);
		getBuilder(ForgeTags.SEEDS_RICE).add(ModItems.RICE);
		getBuilder(ForgeTags.SEEDS_TOMATO).add(ModItems.TOMATO_SEEDS);
		...
		getBuilder(ForgeTags.VEGETABLES_ONION).add(ModItems.ONION);
		getBuilder(ForgeTags.VEGETABLES_POTATO).add(Items.POTATO);
		getBuilder(ForgeTags.VEGETABLES_TOMATO).add(ModItems.TOMATO);
		...
		getBuilder(ForgeTags.TOOLS_KNIVES).add(ModItems.FLINT_KNIFE, ModItems.IRON_KNIFE, ModItems.DIAMOND_KNIFE, ModItems.GOLDEN_KNIFE);
