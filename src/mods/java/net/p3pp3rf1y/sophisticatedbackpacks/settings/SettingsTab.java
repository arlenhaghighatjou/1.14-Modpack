...
public abstract class SettingsTab<C extends SettingsContainerBase<?>> extends SettingsTabBase<SettingsScreen> {
	...
	protected SettingsTab(C settingsContainer, Position position, SettingsScreen screen, ITextComponent tabLabel, List<ITextComponent> tooltip,
			List<ITextComponent> openTooltip, Function<IntConsumer, ButtonBase> getTabButton) {
