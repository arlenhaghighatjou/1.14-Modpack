...
public class BackpackSettingsTab extends SettingsTab<BackpackSettingsContainer> {
			...
			ImmutableMap.of(
					true, getButtonStateData(new UV(80, 32), Dimension.SQUARE_16, new Position(1, 1),
							ImmutableList.of(
									...
									new TranslationTextComponent(translSettingsButton("shift_click_open_tab.on.tooltip")).applyTextStyle(TextFormatting.GRAY))
					),
					false, getButtonStateData(new UV(64, 96), Dimension.SQUARE_16, new Position(1, 1),
							ImmutableList.of(
									...
									new TranslationTextComponent(translSettingsButton("shift_click_open_tab.off.tooltip")).applyTextStyle(TextFormatting.GRAY))
					)
			));
			...
			ImmutableMap.of(
					true, getButtonStateData(new UV(80, 80), Dimension.SQUARE_16, new Position(1, 1),
							ImmutableList.of(
									...
									new TranslationTextComponent(translSettingsButton("keep_tab_open.on.tooltip")).applyTextStyle(TextFormatting.GRAY))
					),
					false, getButtonStateData(new UV(80, 96), Dimension.SQUARE_16, new Position(1, 1),
							ImmutableList.of(
									...
									new TranslationTextComponent(translSettingsButton("keep_tab_open.off.tooltip")).applyTextStyle(TextFormatting.GRAY))
					)
			));
	private static final List<ITextComponent> PLAYER_CONTEXT_TOOLTIP = ImmutableList.of(
			...
			new TranslationTextComponent(translSettingsButton("context_player.tooltip_detail")).applyTextStyle(TextFormatting.GRAY)
	);
	private static final List<ITextComponent> BACKPACK_CONTEXT_TOOLTIP = ImmutableList.of(
			...
			new TranslationTextComponent(translSettingsButton("context_backpack.tooltip_detail")).applyTextStyle(TextFormatting.GRAY)
	);
